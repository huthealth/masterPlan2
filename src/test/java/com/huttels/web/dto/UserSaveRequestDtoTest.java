...
public class UserSaveRequestDtoTest {
    ...
    public void test(){
        ...
        UserSaveRequestDto dto = UserSaveRequestDto.builder().userId("billy104").password("1234").passwordConfirm("1234").email("123@123").build();
        assertThat(dto.getUserId()).isEqualTo("billy104");
